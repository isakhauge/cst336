...
const solarSystem = {
	...
	navbar: '<nav classes="navbar sticky-top navbar-expand-md navbar-light bg-light"><a classes="navbar-brand" href="/lab/solar-system">Solar System</a><button classes="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"><span classes="navbar-toggler-icon"></span></button><div classes="collapse navbar-collapse" id="navbarNav"><ul classes="navbar-nav"><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Sun">Sun</span></a></li><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Mercury_(planet)">Mercury</span></a></li><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Venus">Venus</span></a></li><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Earth">Earth</span></a></li><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Mars">Mars</span></a></li><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Jupiter">Jupiter</span></a></li><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Saturn">Saturn</span></a></li><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Uranus">Uranus</span></a></li><li classes="nav-item"><a classes="nav-link" href="/lab/solar-system?view=Neptune">Neptune</span></a></li></ul></div></nav>',
